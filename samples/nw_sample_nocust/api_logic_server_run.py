...
api_logic_server__version = '17.00.34'
api_logic_server_created__on = 'June 14, 2026 12:53:06'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.00.34\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.00.34\n'
    msg += f'.. startup message: {start_up_message}\n'
