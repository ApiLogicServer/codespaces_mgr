...
api_logic_server__version = '17.00.37'
api_logic_server_created__on = 'June 16, 2026 19:58:06'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.00.37\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.00.37\n'
    msg += f'.. startup message: {start_up_message}\n'
