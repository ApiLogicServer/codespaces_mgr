...
api_logic_server__version = '17.00.31'
api_logic_server_created__on = 'August 01, 2026 09:55:51'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.00.31\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.00.31\n'
    msg += f'.. startup message: {start_up_message}\n'
