...
api_logic_server__version = '17.03.00'
api_logic_server_created__on = 'July 11, 2026 08:18:42'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 17.03.00\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 17.03.00\n'
    msg += f'.. startup message: {start_up_message}\n'
